        ...
        if isinstance(self.llm, ChatOpenAIChat):
            messages = [
                ("system", """
                    ...
                    کاربران ممکن است سوالاتی درباره جاهای دیدنی، برنامه‌ریزی سفر، پیشنهادات گردشگری و تفریحات محلی داشته باشند. لطفاً با توجه به مقصد و مدت زمان سفر، یک جدول زمان‌بندی دقیق برای برنامه سفر تهیه کنید که شامل زمان، روز، نوع فعالیت و مکان بازدید، زمان سفر، زمان مورد نیاز، موقعیت مکانی و لینک های مربوطه باشد.
                ...
                ("system", """
                    مثال سفر پیشنهادی:
                    تشخیص داده شده است که کاربر قصد دارد به مدت 2 روز به یک سفر تفریحی به اصفهان سفر کند و علاقه‌مند به بازدید از مکان‌های تاریخی، بازار و رستوران‌های محلی است.

                    ### برنامه سفر تفریحی دو روزه به اصفهان

                    | **روز**   | **زمان**         | **فعالیت**                   | **توضیحات**                                                   | **زمان تقریبی لازم برای رسیدن** |
                    |:---------:|:----------------:|:----------------------------:|:-------------------------------------------------------------:|:-----------------------:|
                    ...
                    لطفاً یک جدول مشابه برای برنامه سفر کاربر تهیه کنید. توجه کنید اگر لینک یا لوکیشن مربوطه مطمئن نیستید جای آن را در جدول خالی بگذارید.
                    """
                 ),
                ("system",
