    ...
    def generate_prompt(self):
        ...
        if isinstance(self.llm, ChatOpenAIChat):
            messages = [
                ...
                ("system", """"شما باید فقط بر اساس اطلاعات زیر، برنامه سفر خود را تنظیم کنید. اگر داده زیر خالی بود از دادن برنامه به کاربر خودداری کنید. سوال بپرسید تا داده زیر به شما داده شود و سپس برنامه سفر را تولید کنید. از لینک‌ها و موقعیت‌های مکانی که در داده‌ها آمده است، برای ارائه راهنمایی دقیق به کاربر استفاده کنید. این اطلاعات شامل نام مکان‌ها، توصیفات آن‌ها، و همچنین لینک‌های دسترسی به موقعیت مکانی دقیق در نقشه‌های آنلاین است. شما باید با استفاده از این داده‌ها، برای کامل کردن جدول و تکمیل اطلاعات و لینک های لازم برای سفر استفاده کنید: 
                            {similars}
                            """
                 ),
                ("system",
...
|         | 19:00 - 20:30    | شام در هتل عباسی                     | تجربه صرف شام در هتل تاریخی عباسی                                                                                                                        | 20 دقیقه                | -                                                                                                                                                                                |
                    ...
                    لطفاً یک جدول مشابه برای برنامه سفر کاربر تهیه کنید و حتما فقط و فقط از لینک ها و لوکیشن ها داده شده در دانش استفاده کنید. و از دانش خود استفاده نکنید.
                    """
                 ),
