            ...
            messages = [
                ...
                ("system", """
                  ...
                  مثال سفر پیشنهادی دوم:
                    تشخیص داده شده است که کاربر قصد دارد به مدت 2 روز به یک سفر توریستی به استانبول برود و علاقه‌مند به بازدید از مکان‌های تاریخی، جاذبه های گردشگی و غذا های محلی است.

                    ### برنامه سفر تفریحی دو روزه به استانبول
