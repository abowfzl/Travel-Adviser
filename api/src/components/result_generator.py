...
لطفاً یک جدول مشابه برای برنامه سفر کاربر تهیه کنید.
                ...
                """),
                ("system", "با استفاده از نتایج زیر به عنوان دانش خود به سوال پاسخ دهید همچنین از لینک ها در این دانش و همچنین در صورت صحیح بودن این دانش در پاسخ خود برای راهنمایی بهتر کاربر استفاده کنید: {similars}"),
