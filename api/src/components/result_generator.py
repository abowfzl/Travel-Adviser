    ...
    def generate_prompt(self):
        ...
        if isinstance(self.llm, ChatOpenAIChat):
            messages = [
                ...
                ("system", "از دادن برنامه سریع خودداری کنید. باید سوالات کافی بپرسید و تشخیص دهید که هدف کاربر از سفرش چیست. برای مثال وقتی هدف سفر کاری باشد خیلی مکان هایی که از مرکز شهر دور هستند مورد پستد کاربر نیست ولی وقتی هدف سفر توریستی و تفریحی باشد باید در برنامه جاهای دیدنی و تاریخی و معروف مقصد گنجانده شود."),
                ("system", """
                ...
                ("system", "تا جای ممکن از ذکر رستوران محلی خودداری کنید، سعی کنید اسم رستوران و همچنین یا حداقل نام غذای معروف مقصد را ذکر کنید."),
                ("system", """
...
|         | 19:00 - 20:30    | شام در هتل عباسی                     | تجربه صرف شام در هتل تاریخی عباسی                                                                                                                        | 20 دقیقه                | -                                                                                                                                                                                |
                ...
                ("system",
                    "بر اساس اطلاعات زیر، برنامه سفر خود را تنظیم کنید. از لینک‌ها و موقعیت‌های مکانی که در داده‌ها آمده است، برای ارائه راهنمایی دقیق به کاربر استفاده کنید. این اطلاعات شامل نام مکان‌ها، توصیفات آن‌ها، و همچنین لینک‌های دسترسی به موقعیت مکانی دقیق در نقشه‌های آنلاین است. شما می‌توانید با استفاده از این داده‌ها، برنامه‌ای جامع و کاربردی برای سفر به مقصد ارائه دهید: {similars}"
                 ),
