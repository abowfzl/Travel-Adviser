...
function ChatContainer(props: ChatContainerProps) {
  ...
  return (
    <div className="relative flex flex-col w-full min-w-[320px] max-w-full overflow-y-auto rounded-lg shadow-lg bg-light-bg dark:bg-dark-bg transition-colors duration-300 p-2 md:p-4 lg:p-6">
